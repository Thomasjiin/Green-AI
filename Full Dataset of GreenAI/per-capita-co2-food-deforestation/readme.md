# Per capita CO₂ emissions from deforestation for food production - Data package

This data package contains the data that powers the chart ["Per capita CO₂ emissions from deforestation for food production"](https://ourworldindata.org/grapher/per-capita-co2-food-deforestation?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on December 03, 2025.
...
This measures per capita CO₂ emissions linked to deforestation for food production – it is trade-adjusted so reflects the carbon footprint of diets within a given country. It is based on the annual average over the period from 2010 to 2014.
...
#### Full citation
Pendrill et al. (2019). Agricultural and forestry trade drives large share of tropical deforestation emissions. – processed by Our World in Data. “Per capita CO₂ emissions from deforestation for food production” [dataset]. Pendrill et al. (2019). Agricultural and forestry trade drives large share of tropical deforestation emissions. [original data].
